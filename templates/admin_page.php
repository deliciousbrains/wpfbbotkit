...
<div class="<?php echo $this->string_ns;?>container">
	<h1>WPFBBotKit Settings</h1>

	<p><strong>Webhook URL: </strong><input type="text" class="copyable" value='<?php echo $this->get_webhook_url(); ?>' /></p>
	<p><strong>Verification String: </strong><input type="text" class="copyable" value='<?php echo $this->get_verification_string(); ?>' /></p>
